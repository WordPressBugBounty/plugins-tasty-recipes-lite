...
<div class="notice notice-warning tasty-recipes-admin-notice" id="tasty-recipes-db-migration-notice">
	<p class="tasty-recipes-admin-notice-message">
	...
	<button type="button" class="tasty-recipes-admin-notice-button" id="tasty-recipes-run-migration">
