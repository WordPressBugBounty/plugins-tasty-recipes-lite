...
if ( ! function_exists( 'tasty_register_1_dot_1_dot_15' ) ) {
	...
	add_action( 'plugins_loaded', 'tasty_register_1_dot_1_dot_15', 0 );
	 ...
	 * @return void
	 */
	function tasty_register_1_dot_1_dot_15() {
		Versions::instance()->register( '1.1.15', 'tasty_initialize_1_dot_1_dot_15' );
	}
	 ...
	 * @return void
	 */
	function tasty_initialize_1_dot_1_dot_15() {
